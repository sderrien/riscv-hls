...
unsigned int read_u32() { return read_hex(8); }

unsigned int read_u16() { return read_hex(4); }

unsigned int read_u8() { return read_hex(2); }
...
void write_u32(uint32_t value) { write_uxx(value, 8); }

void write_u16(uint16_t value) { write_uxx(value, 4); }

void write_u8(uint16_t value) { write_uxx(value, 2); }
...
uint32_t debug_get_pc() { return debug_read_reg(32); }
...
bool debug_is_valid_addr(uint32_t addr) { return 1; }
