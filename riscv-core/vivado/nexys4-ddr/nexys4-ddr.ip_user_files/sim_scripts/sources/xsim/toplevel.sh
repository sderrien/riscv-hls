...
#
# Generated by Vivado on Thu Dec 15 07:42:08 PST 2022
...
xv_boost_lib_path=/soft/Vitis/Vitis-2020.1/Vivado/2020.1/tps/boost_1_64_0
xvlog_opts="--relax"


# Script info
echo -e "toplevel.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
{
  file="xsim.ini"
  lib_map_path="/opt/xilinx/vitis_hd/Vitis-2020.1/Vivado/2020.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
