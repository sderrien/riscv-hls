...
architecture behav of read_byte is 
    ...
    signal trunc_ln80_fu_90_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal uart_blk_n_R : STD_LOGIC;
    signal ap_CS_fsm_state16 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state16 : signal is "none";
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal uart_addr_reg_94 : STD_LOGIC_VECTOR (31 downto 0);
    signal uart_addr_2_reg_100 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln78_fu_60_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln80_fu_80_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state9_io : BOOLEAN;
    signal zext_ln78_1_fu_64_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal add_ln80_fu_74_p2 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    uart_addr_2_reg_100(30 downto 0) <= zext_ln80_fu_80_p1(32 - 1 downto 0)(30 downto 0);
                    uart_addr_reg_94(29 downto 0) <= zext_ln78_fu_60_p1(32 - 1 downto 0)(29 downto 0);
            end if;
        end if;
    end process;
    uart_addr_reg_94(31 downto 30) <= "00";
    uart_addr_2_reg_100(31) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_uart_ARREADY, m_axi_uart_RVALID, ap_CS_fsm_state9, trunc_ln80_fu_90_p1, ap_CS_fsm_state16, ap_CS_fsm_state2, ap_block_state9_io)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state9 => 
                if ((not(((m_axi_uart_RVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state9_io))) and (trunc_ln80_fu_90_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
                    ap_NS_fsm <= ap_ST_fsm_state10;
                elsif ((not(((m_axi_uart_RVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state9_io))) and (trunc_ln80_fu_90_p1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state9))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state9;
                end if;
            ...
            when ap_ST_fsm_state16 => 
                if (((m_axi_uart_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state16;
                end if;
    ...
    add_ln80_fu_74_p2 <= std_logic_vector(unsigned(zext_ln78_1_fu_64_p1) + unsigned(ap_const_lv31_2));
    ap_CS_fsm_state1 <= ap_CS_fsm(0);
    ap_CS_fsm_state16 <= ap_CS_fsm(15);
    ap_CS_fsm_state2 <= ap_CS_fsm(1);
    ap_CS_fsm_state9 <= ap_CS_fsm(8);

    ap_block_state9_io_assign_proc : process(m_axi_uart_ARREADY, trunc_ln80_fu_90_p1)
    begin
                ap_block_state9_io <= ((trunc_ln80_fu_90_p1 = ap_const_lv1_1) and (m_axi_uart_ARREADY = ap_const_logic_0));
    end process;


    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_uart_RVALID, ap_CS_fsm_state16)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((m_axi_uart_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16)))) then 
    ...
    ap_ready_assign_proc : process(m_axi_uart_RVALID, ap_CS_fsm_state16)
    begin
        if (((m_axi_uart_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16))) then 
    ...
    ap_return <= m_axi_uart_RDATA;

    m_axi_uart_ARADDR_assign_proc : process(m_axi_uart_ARREADY, m_axi_uart_RVALID, ap_CS_fsm_state9, trunc_ln80_fu_90_p1, ap_CS_fsm_state2, uart_addr_reg_94, uart_addr_2_reg_100, ap_block_state9_io)
    begin
        if ((not(((m_axi_uart_RVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state9_io))) and (trunc_ln80_fu_90_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9))) then 
            m_axi_uart_ARADDR <= uart_addr_reg_94;
        elsif (((m_axi_uart_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_uart_ARADDR <= uart_addr_2_reg_100;
        else 
    ...
    m_axi_uart_ARVALID_assign_proc : process(m_axi_uart_ARREADY, m_axi_uart_RVALID, ap_CS_fsm_state9, trunc_ln80_fu_90_p1, ap_CS_fsm_state2, ap_block_state9_io)
    begin
        if (((not(((m_axi_uart_RVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state9_io))) and (trunc_ln80_fu_90_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9)) or ((m_axi_uart_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    m_axi_uart_RREADY_assign_proc : process(m_axi_uart_RVALID, ap_CS_fsm_state9, ap_CS_fsm_state16, ap_block_state9_io)
    begin
        if (((not(((m_axi_uart_RVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state9_io))) and (ap_const_logic_1 = ap_CS_fsm_state9)) or ((m_axi_uart_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state16)))) then 
    ...
    trunc_ln80_fu_90_p1 <= m_axi_uart_RDATA(1 - 1 downto 0);

    uart_blk_n_AR_assign_proc : process(m_axi_uart_ARREADY, ap_CS_fsm_state9, trunc_ln80_fu_90_p1, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((trunc_ln80_fu_90_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state9)))) then 
    ...
    uart_blk_n_R_assign_proc : process(m_axi_uart_RVALID, ap_CS_fsm_state9, ap_CS_fsm_state16)
    begin
    ...
    zext_ln78_1_fu_64_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(uart_offset),31));
    zext_ln78_fu_60_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(uart_offset),64));
    zext_ln80_fu_80_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln80_fu_74_p2),64));
end behav;
